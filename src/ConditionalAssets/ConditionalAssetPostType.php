...
class ConditionalAssetPostType
{
    const KEY = 'conditional-asset';
    const SINGULAR = 'Conditional Asset';
    const PLURAL = 'Conditional Assets';
    const SLUG = 'conditional-assets';
    ...
    public function get_labels() {
        ...
        $text_domain = 'conditional-assets';
        $labels = [
